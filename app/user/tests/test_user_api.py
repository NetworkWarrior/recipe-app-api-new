...
class PublicUserApiTests(TestCase):
    ...
    def test_create_user_succes(self):
        ...
        self.assertNotIn(self.payload['password'], res.data)

    def test_user_with_email_exists_error(self):
        """Test error returned if user wwith email exists."""
    ...
    def test_create_token_for_valid_user(self):
        """Test generates token for walid credentials."""
        create_user(**self.payload)
        payload = {
    ...
    def test_create_token_blank_password(self):
        """Test posting a blank passwordd returns an error."""
...
class PrivateUserApiTests(TestCase):
    ...
    def test_retriews_profile_succes(self):
    ...
    def test_post_me_not_allowed(self):
        """Test POST is not allowed for the me endpoin."""
